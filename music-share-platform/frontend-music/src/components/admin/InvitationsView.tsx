    ...
    return (
        <PageTransition className="p-8 max-w-6xl mx-auto">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 tracking-tight">초대 링크</h1>
                    <p className="text-gray-500 mt-1">접속 링크를 생성하고 관리하세요.</p>
                </div>
                <button
                    onClick={loadData}
            ...
            <div className="grid gap-8 lg:grid-cols-2">
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <div className="border border-gray-200 rounded-lg max-h-60 overflow-y-auto scrollbar-thin">
                                {tracks.length === 0 ? (
                                    <div className="p-4 text-center text-gray-500 text-sm">사용 가능한 트랙이 없습니다.</div>
                                ) : (
                                    tracks.map(track => (
                                        <label
                                            key={track.id}
                    ...
                    {newInviteCode && (
                        <div className="mt-6 p-4 bg-green-50 border border-green-100 rounded-lg animate-in fade-in slide-in-from-top-2">
                            <div className="flex items-center justify-between mb-2">
                                <span className="text-sm font-semibold text-green-800">공유 준비 완료!</span>
                                <button
                ...
                <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-100 p-6 flex flex-col h-[600px]">
                    <h2 className="text-lg font-semibold text-gray-900 mb-6">활성 초대 링크</h2>
