    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="px-4 py-4 sm:px-6">
          ...
          <p className="mt-1 text-sm text-gray-500">계정 및 프로필 설정을 관리합니다.</p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row">
        {/* 데스크톱: 사이드바 */}
        <div className="hidden sm:block w-64 bg-white border-r border-gray-200 min-h-[calc(100vh-120px)]">
          ...
          {activeTab === 'profile' && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <div className="p-4 sm:p-6 border-b border-gray-200">
                ...
                <p className="mt-1 text-sm text-gray-500">기본 프로필 정보를 수정합니다.</p>
              </div>
              ...
              <form onSubmit={handleProfileUpdate} className="p-4 sm:p-6 space-y-6">
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full sm:w-auto px-6 py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
          ...
          {activeTab === 'password' && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <div className="p-4 sm:p-6 border-b border-gray-200">
                ...
                <p className="mt-1 text-sm text-gray-500">계정 보안을 위해 정기적으로 비밀번호를 변경하세요.</p>
              </div>
              ...
              <form onSubmit={handlePasswordChange} className="p-4 sm:p-6 space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-400">6자 이상 입력하세요.</p>
                </div>
